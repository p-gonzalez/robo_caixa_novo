...
public class UtilDate {
	...
	public static void main(String[] args) {
		Date data = convertToDate("01/08/19 00:27:15", PATTERN_DD_MM_YY_HH_MM_SS);
		Calendar cal = Calendar.getInstance();
		cal.setTime(data);
		System.out.println(cal.get(Calendar.MINUTE));
		System.out.println(convertToString(data, PATTERN_YYYYMMDDHH_MMSS));
		System.out.println(convertToString(data, PATTERN_HHmmss));
	}
}